export const templates = {
    ...
    otherAsset: () => `
        ...
        <td class="px-4 py-2"><input data-id="loan" type="text" data-type="currency" placeholder="$10,000" class="input-base w-full text-right text-pink-500"></td>
        <td class="px-4 py-2 text-center"><button data-action="remove" class="btn-icon"><i class="fas fa-times"></i></button></td>`,
    ...
    heloc: () => `
        ...
        <td class="px-4 py-2 text-right"><input data-id="rate" type="number" placeholder="5.0" class="input-base w-24 text-right"></td>
        <td class="px-4 py-2 text-center"><button data-action="remove" class="btn-icon"><i class="fas fa-times"></i></button></td>`,

    debt: () => `
        <td class="px-4 py-2"><input data-id="name" type="text" placeholder="e.g., Credit Card" class="input-base w-full"></td>
        <td class="px-4 py-2"><input data-id="balance" type="text" data-type="currency" placeholder="$0" class="input-base w-full text-right text-pink-500"></td>
        <td class="px-4 py-2 text-right"><input data-id="rate" type="number" placeholder="22.9" class="input-base w-24 text-right"></td>
        <td class="px-4 py-2 text-center"><button data-action="remove" class="btn-icon"><i class="fas fa-times"></i></button></td>`,
    ...
    income: () => `
        <div class="p-5 space-y-4 relative group">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-4 pl-12">
                ...
                <div>
                    <label class="label-form text-white block text-right">Non-Taxable Until</label>
